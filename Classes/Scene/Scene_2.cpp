...
Scene_2::Scene_2() {
    ...
    //     ModelSources::Planet,
    //     ShaderType::Constant,
    //     new TextureInstance("../Models/sun_texture.jpg"), // yellow sun
    //     Materials::Metal
    // );
    //
    // addObject(sun)
    ...
    //     ModelSources::Planet,
    //     ShaderType::Blinn,
    //     new TextureInstance("../Models/earth_texture.jpg"), // blue Earth
    //     Materials::Wood
    // );
    //
    ...
    //     ModelSources::Planet,
    //     ShaderType::Blinn,
    //     new TextureInstance("../Models/moon_texture.jpg"), // grey Moon
    //     Materials::Wood
    // );
    //
